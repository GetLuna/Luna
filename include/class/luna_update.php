...
class AutoUpdate {
	...
	public $updateUrl = 'http://localhost/lns/update/';
	...
	public function checkUpdate() {
		...
		if ($luna_config['o_update_ring'] == 0)
			$updateFile = 'https://raw.githubusercontent.com/GetLuna/UpdateService/master/'.$luna_config['o_code_name'].'.ini';
		elseif ($luna_config['o_update_ring'] == 1)
			$updateFile = 'https://raw.githubusercontent.com/GetLuna/UpdateService/master/master.ini';
		elseif ($luna_config['o_update_ring'] == 2)
			$updateFile = 'https://raw.githubusercontent.com/GetLuna/UpdateService/master/preview.ini';
		elseif ($luna_config['o_update_ring'] == 3)
			$updateFile = 'https://raw.githubusercontent.com/GetLuna/UpdateService/master/nightly.ini';
	...
	public function install($updateFile) {
		...
		$this->log('Update \''.$this->latestVersionName.'\' installed.');
	...
	public function update() {
		...
		if ($this->latestVersion > $this->currentVersion) {
			...
			$updateFile = $this->tempDir.'/'.$this->latestVersionName.'.zip';
			$updateUrl = 'http://getluna.org/update/'.$this->latestVersionName.'.zip';
