...
<?php if ($group['g_id'] != FORUM_ADMIN): if ($group['g_id'] != FORUM_GUEST): if ($mode != 'edit' || $pun_config['o_default_user_group'] != $group['g_id']): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Mod privileges help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Edit profile help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Rename users help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Change passwords help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Ban users help'] ?></span>
                    </td>
                </tr>
<?php endif; endif; ?>								<tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Read board help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['View user info help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Post replies help'] ?></span>
                    </td>
                </tr>
                <tr>
...
<?php if ($group['g_id'] != FORUM_GUEST): ?>								<tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Edit posts help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Delete posts help'] ?></span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Delete topics help'] ?></span>
                    </td>
                </tr>
<?php endif;
if ($group['g_id'] != FORUM_GUEST): ?>								<tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Set own title help'] ?></span>
                    </td>
                </tr>
<?php endif; ?>								<tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['User search help'] ?></span>
                    </td>
                </tr>
                <tr>
...
<?php if ($group['g_id'] != FORUM_GUEST): ?>								<tr>
                    ...
                    <td>
                        ...
                        <br /><span class="clearb"><?php echo $lang_admin_groups['Send e-mails help'] ?></span>
                    </td>
                </tr>
<?php endif; ?>								<tr>
    ...
    <form method="post" action="groups.php?del_group=<?php echo $group_id ?>">
        <input type="hidden" name="group_to_delete" value="<?php echo $group_id ?>" />
            <fieldset>
                ...
                <div class="alert alert-danger"><?php echo $lang_admin_groups['Confirm delete warn'] ?></div>
            </fieldset>
        <div class="control-group">
            <input class="btn btn-danger" type="submit" name="del_group_comply" value="<?php echo $lang_admin_common['Delete'] ?>" tabindex="1" />
            <a class="btn" href="javascript:history.go(-1)" tabindex="2"><?php echo $lang_admin_common['Go back'] ?></a>
        </div>
    </form>
</div>
<?php
...
?>
        ...
        <p class="control-group">
        	<input class="btn btn-danger" type="submit" name="del_group" value="<?php echo $lang_admin_groups['Delete group'] ?>" />
