...
'Info 4'						=>	'The name of the database you want to install ModernBB on.',
...
'Info 6'						=>	'If you want to run multiple ModernBB installations in a single database, change this.',
...
'Info 14'						=>	'The URL (without trailing slash) of your ModernBB forum (example: http://forum.myhost.com). This must be correct. Please note that the preset value below is just an educated guess by ModernBB.',
