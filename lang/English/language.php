...
'Closed explenation'			=>	'When a topic is closed, you can\'t add a new comment to it, except if you have a permission that overwrites this. The topic is still available to read, through.',
'Moved explenation'				=>	'This topic is moved to another forum. Admins and moderators can choose to show this notification, or simply not show it at all. The original forum where this topic was located in, won\'t show any topic stats anymore.',
'Star'							=>	'Star',
'Star explenation'				=>	'You\'re following this topic, they will show up in you\'re subscibtion list.',
'Posted explenation'			=>	'Topics labeled with this label contain a comment of you.',
'WYSIWYG question'				=>	'I can\'t see the WYSIWYG editor!',
'WYSIWYG answer'				=>	'You probably did not enable JavaScript in your browser, you can find this under settings in your browser. It could be that you are using an unsupported browser that doesn\'t hancle the editor properly, too.',
'Content question'				=>	'Smilies, signatures, avatars and images are not visible?',
'Content answer'				=>	'You can change the behavior of the topic view in your profiles settings. Here you can enable smilies, signatures, avatars and images in posts. Through by default, those settings are enabled. Your forums admin might have disabled those features. You can see if images and smilies are disabled below the editor. If the labels have a red background, those features aren\'t available for you.',
'Topics question'				=>	'Why can\'t I see any topics or forums?',
'Topics answer'					=>	'You might not have the correct permissions to do so, ask the forums administrator for more help.',
'Profile question'				=>	'Why can\'t I see any profiles?',
'Profile answer'				=>	'You might not have the correct permissions to do so, ask the forums administrator for more help.',
'Information question'			=>	'My profile doesn\'t contain as much as others?',
'Information answer'			=>	'You\'re profile will only display fields that are enabled and filled in on your profiles personality page. You might want to take a look over there and check if you missed some fields.',
'Advanced search question'		=>	'Are there more options to search?',
'Advanced search answer'		=>	'When you go to the search page, you\'ll find yourself on a page with 1 searchbox. Below that search box, there is a link to Advanced search, here you can find more search options! Note that this feature isn\'t available on small devices or is disabled on all devices by the forums admin.',
'More search question'			=>	'I can\'t search in more then 1 forum at once?',
'More search answer'			=>	'You might not have the correct permissions to do so, ask the forums administrator for more help.',
'Moderating'					=>	'Moderating',
'Moderating info'				=>	'Admins and moderators like help too, sometimes. So, allow us to explain those basics here.',
...
'Moderate user answer 1'		=>	'Moderator options are available in the users profile. You can find the moderation options under "Administration" in the users profile menu. Those features aren\'t available for all moderators.',
'Moderate user answer 2'		=>	'The Administration page allow you to check if the user has any admin note, and if required, you can change that note. You can also change the post count of this user. At this page, the user can also be given moderator permissions on a per-forum base, through the user must have a moderator account to be able to actualy use those permissions.',
'Moderate user answer 3'		=>	'Finaly, you can ban or delete a user from his profile. If you want to ban and/or delete multiple users at once, you\'re probably better of with the advanced user management features in the Backstage.',
...
'Indent help'						=>	'Amout of spaces that represent a tab',
...
'Mod privileges help'			=>	'In order for a user to have moderator abilities, he/she must be assigned to moderate one or more forums. This is done via the user administration page of the user\'s profile.',
...
'User list search help'			=>	'Allow users to freetext search for users in the user list.',
...
'Moderator info'				=>	'Please note that in order for a user to have moderator abilities, he/she must be assigned to moderate one or more forums. This is done via the user administration page of the user\'s profile.',
'seconds'						=>	'seconds',
'pixels'						=>	'pixels',
...
'Rebuild index info'			=>	'If you changes something about topics and posts in the datahase you should rebuild the search index. It\'s recommended to activate %s during rebuilding. This can take a while and can increase the server load during the process!',
...
'Rebuild completed info'		=>	'Be sure to enable JavaScript during the rebuild (to start a new cycle automaticaly). When you have to abort the rebuilding, remember the last post ID and enter that ID+1 in "Starting post ID" if you want to continue (Uncheck "Empty index").',
...
'Mailing list help'					=>	'A comma separated list of subscribers who get mails when new reports are made',
...
'Rules help'						=>	'Enter rules or usefull information, required when rules are enabled',
