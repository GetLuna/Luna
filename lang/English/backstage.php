...
'Second feature 1 info'		=>	'ModernBB features a brand new login form. With less clutter, it\'s straight to the point. ModernBB will also check the "Remember me" checkbox by default. A true login experience.',
'Second feature 2 head'		=>	'Modernized frontend.',
'Second feature 2 info'		=>	'Not only Backstage, but also the frontend has been rewritten. The new frontend of ModernBB is, just like Backstage, build with Bootstrap 3 and features brand new styles for you.',
...
'Second feature 4 head'		=>	'Stop forum spam with StopForumSpam.',
'Second feature 4 info'		=>	'We\'ve added a new feature that fights against forum spam, spambots to be exact. You need only an API Key from StopForumSpam.com for this feature to work.',
'Second feature 5 head'		=>	'A more simple search.',
'Second feature 5 info'		=>	'By default, users will now see a more simple search page, all options are still there, but hidden under a simple button, making search a better experience.',
'Second feature 6 head'		=>	'Easy edit.',
'Second feature 6 info'		=>	'A much requested feature for ModernBB has made it to the core, we\'ve added a toolbar to textareas so it\'s easier for your users to add BBCode in their messages.',
'Second feature 7 head'		=>	'Keep your userbase clean',
'Second feature 7 info'		=>	'The Maintenance page now features an user prune feature. Making it more easy to clean up old users and users without posts or activation.',
'Second feature 8 head'		=>	'Embed videos.',
'Second feature 8 info'		=>	'We introduce also a new parser. One of the improvements we made is the support for video embedding. This new features supports DaiyMotion, Vimeo and YouTube.',
'Second feature 9 head'		=>	'Sub forum support.',
'Second feature 9 info'		=>	'We do realize that sub forum support is an essential feature these days. That\'s why ModernBB 2 does support sub forums natively, making your forum structure better.',
...
'Minor feature 5 head'		=>	'Marked as reported.',
'Minor feature 5 info'		=>	'When users report a post, that post will become in a "freezed" mode for every other person that want to report it again. They will be marked in red and the report button will be disabled.',
'Minor feature 6 head'		=>	'New faces join the party.',
'Minor feature 6 info'		=>	'5 new emoticons are added to ModernBB, along with 13 new BBCodes to write them down. All other emoticons have had a make-over, giving them a more crispy design.',
'Minor feature 7 head'		=>	'Cleanup templates.',
'Minor feature 7 info'		=>	'All pages in ModernBB are generated with a couple of simple templates, at least, they are now. We\'ve rewritten the templates, they are clean, simple and light.',
'Minor feature 8 head'		=>	'Clean registration.',
'Minor feature 8 info'		=>	'ModernBB 2 also improves the registration for new users. With a simplified registration form, your future users will be able to start using your forum faster without unneeded information.',
'Minor feature 9 head'		=>	'Super subscript.',
'Minor feature 9 info'		=>	'The new parser supports, beside video embedding, also the use of subscript and superscript text. This makes it easier for your boards users to write to mathematical formulas and more.',
...
'Add category help'				=>	'The name of the new category you want to add. Go to %s to add forums to categories.',
...
'Delete category help'			=>	'Select the name of the category you want to delete.',
...
'Board title help'					=>	'The title of this bulletin board. This field may <strong>not</strong> contain HTML.',
...
// Language for toolbar.php

'plugin_desc'			=>	'Here you can configure the general settings of toolbar, and buttons assignments.',
'glob_conf'				=>	'General Configuration',
'button_conf'			=>	'Buttons Configuration',
'tag_conf'				=>	'Tags Configuration',
'create_conf'			=>	'Create tag',
'regenerate'			=>	'Regenerate all the toolbar cache files',

'settings'				=>	'Global settings',
'enable_form'			=>	'Enable on classic forms',
'enable_form_infos'		=>	'Enable or disable the toolbar on "classic" forms (post.php et edit.php)',
'enable_quickform'		=>	'Enable on quick reply',
'enable_quickform_infos'=>	'Enable or disable the toolbar on "quick reply" form (viewtopic.php)',
...
'delete'				=>	'Delete',
'edit_info'				=>	'Note: remember to modify the file <em>include/parser.php</em> for the parser to work correctly, and possibly the bt_[name](_msg_n) message(s) in your lang files (toolbar.php).',
...
'pos_info'				=>	'The position of the new button in the toolbar.',
