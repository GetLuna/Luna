...
'Minor feature 4 head'		=>	'Marked as reported.',
'Minor feature 4 info'		=>	'When users report a post, that post will become in a "freezed" mode for every other person that want to report it again. They will be marked in red and the report button will be disabled.',
'Minor feature 5 head'		=>	'New faces join the party.',
'Minor feature 5 info'		=>	'5 new emoticons are added to ModernBB, along with 13 new BBCodes to write them down. All other emoticons have had a make-over, giving them a more crispy design.',
'Minor feature 6 head'		=>	'Cleanup templates.',
'Minor feature 6 info'		=>	'All pages in ModernBB are generated with a couple of simple templates, at least, they are now. We\'ve rewritten the templates, they are clean, simple and light.',
'Minor feature 7 head'		=>	'Clean registration.',
'Minor feature 7 info'		=>	'ModernBB 2 also improves the registration for new users. With a simplified registration form, your future users will be able to start using your forum faster without unneeded information.',
'Minor feature 8 head'		=>	'Super subscript.',
'Minor feature 8 info'		=>	'The new parser supports, beside video embedding, also the use of subscript and superscript text. This makes it easier for your boards users to write to mathematical formulas and more.',
