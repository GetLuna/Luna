...
<div class="container">
	<h2 class="profile-title"><?php printf(__('Edit "%s"', 'luna'), luna_htmlspecialchars($cur_comment['subject'])) ?><a class="btn btn-danger pull-right" href="viewtopic.php?id=<?php echo $cur_comment['tid'] ?>"><span class="fa fa-fw fa-chevron-left"></span> <?php _e('Cancel', 'luna') ?></a></h2>
<?php 
if (isset($errors))
