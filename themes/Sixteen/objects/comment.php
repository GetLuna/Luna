<div class="postview">
	<div id="p<?php echo $cur_comment['id'] ?>" class="row topic <?php echo ($post_count % 2 == 0) ? ' roweven' : ' rowodd' ?><?php if ($cur_comment['id'] == $cur_thread['first_post_id']) echo ' firstpost'; ?><?php if ($post_count == 1) echo ' onlypost'; ?><?php if ($cur_comment['marked'] == true) echo ' marked'; ?><?php if ($cur_comment['id'] == $cur_thread['answer']) echo ' answer'; ?>">
		<div class="col-md-3">
