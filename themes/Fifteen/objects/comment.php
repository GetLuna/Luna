	...
	<div class="comment-heading">
		<div class="media">
			<div class="media-left">
				<img class="media-object comment-avatar" src="<?php echo get_avatar( (!isset($inbox))? $cur_comment['commenter_id'] : $cur_comment['owner'] ) ?>" alt="Avatar">
			</div>
			<div class="media-body">
				...
				<?php echo get_title( $cur_comment ) ?> &middot; <?php echo luna_number_format($cur_comment['num_comments']) ?> <?php _e( 'comments', 'luna' ) ?>
			</div>
		</div>
	</div>
