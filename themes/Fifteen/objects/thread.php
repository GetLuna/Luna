<div class="list-group-item <?php echo $item_status ?><?php if ($cur_thread['soft'] == true) echo ' soft'; ?>">
	...
	<?php if ($cur_thread['moved_to'] == 0) { ?>
		<span class="text-muted"> &middot;
			...
			&middot; <?php echo $forum_name ?> &middot; <?php if ($cur_thread['moved_to'] == 0) { ?><span class="label label-default"><?php echo forum_number_format($cur_thread['num_replies']) ?></span><?php } ?>
		</span>
	<?php } ?>
</div>
