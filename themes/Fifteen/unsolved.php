...
<form class="form-horizontal" id="report" method="post" action="misc.php?unanswer=<?php echo $post_id ?>&amp;tid=<?php echo $answer_id ?>" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title"><?php _e('Unsolved', 'luna') ?></h3>
		</div>
