		...
		<div class="col-xs-12">
			<form class="form-horizontal" id="report" method="post" action="misc.php?report=<?php echo $comment_id ?>" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">
				<div class="title-block title-block-primary">
					<h2><i class="fa fa-fw fa-flag"></i> <?php _e( 'Report', 'luna' ) ?><span class="pull-right"><button type="submit" class="btn btn-default" name="submit" accesskey="s"><span class="fa fa-fw fa-check"></span> <?php _e('Submit', 'luna') ?></button></span></h2>
				</div>
