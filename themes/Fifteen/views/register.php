	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" id="register" method="post" action="register.php?action=register" onsubmit="this.register.disabled=true;if(process_form(this)){return true;}else{this.register.disabled=false;return false;}">
				...
				<h2><i class="fas fa-fw fa-user"></i> <?php _e('Register', 'luna') ?><span class="float-right"><button type="submit" class="btn btn-default" name="register"><span class="fas fa-fw fa-check"></span> <?php _e('Register', 'luna') ?></button></span></h2>
				</div>
