		...
		<div class="row">
			<div class="col-xs-12">
				<div class="title-block title-block-danger">
					<h2><i class="fas fa-fw fa-user"></i> <?php _e('Confirm deletion', 'luna') ?> &middot; <?php echo luna_htmlspecialchars($username) ?><span class="float-right"><button type="submit" class="btn btn-default" name="delete_user_comply" accesskey="s"><span class="fas fa-fw fa-trash-alt"></span> <?php _e('Delete', 'luna') ?></button></span></h2>
				</div>
