		...
		<div class="col-xs-12">
			<form method="post" action="delete.php?id=<?php echo $id ?>&action=soft">
				<div class="title-block title-block-danger">
					<h2><i class="fas fa-fw fa-trash"></i> <?php draw_delete_title(); ?><span class="float-right"><button type="submit" class="btn btn-default" name="soft_delete"><span class="fas fa-fw fa-trash"></span> <?php _e('Hide', 'luna') ?></button></span></h2>
				</div>
