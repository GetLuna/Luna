			...
			<div class="panel-body">
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading"><?php printf(__('By %s', 'luna'), $username) ?><small class="pull-right"><a class="posttime" href="<?php if (!isset($inbox)) { echo 'viewtopic.php?pid='.$cur_post['id'].'#p'.$cur_post['id']; } else { echo 'viewinbox.php?tid='.$cur_post['shared_id'].'&mid='.$cur_post['mid']; } ?>"><?php echo format_time($cur_post['posted']) ?></a></small></h4>
					</div>
				</div>
				<hr />
