<div id="p<?php echo $cur_post['id'] ?>" class="row comment <?php echo ($post_count % 2 == 0) ? ' roweven' : ' rowodd' ?><?php if (!$inbox) { if ($cur_post['id'] == $cur_topic['first_post_id']) echo ' firstpost'; if ($post_count == 1) echo ' onlypost'; if ($cur_post['marked'] == true) echo ' marked'; if ($cur_post['soft'] == true) echo ' soft'; } ?>">
	...
	<div class="col-xs-10 col-md-10 col-lg-11 col-no-padding-left">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<?php if (!$inbox) { if ($cur_post['edited'] != '') echo '<p class="postedit"><em>'.$lang['Last edit'].' '.luna_htmlspecialchars($cur_post['edited_by']).' ('.format_time($cur_post['edited']).')</em></p>'; }; ?>
