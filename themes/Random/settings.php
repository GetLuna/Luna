...
<form id="profile-settings" method="post" action="settings.php?id=<?php echo $id ?>">
	<h2 class="profile-settings-head">Settings<span class="pull-right"><button class="btn btn-primary" type="submit" name="update"><span class="fa fa-fw fa-check"></span> <?php _e('Save', 'luna') ?></button></span></h2>
	<div role="tabpanel">
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="profile">
				<fieldset class="form-horizontal form-setting">
					...
					<hr />
					<div class="form-group">
						<label class="col-sm-3 control-label">Avatar<span class="help-block"><?php _e('Upload an image to represent you', 'luna') ?></span></label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Signature<span class="help-block"><?php _e('Write a small piece to attach to every post you make', 'luna') ?></span></label>
						<div class="col-sm-9">
