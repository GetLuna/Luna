...
<div class="alert alert-info alert-section"<?php echo $style ?>>
	<h3 class="inline"><?php echo $cur_section['forum_name']; ?></h3><span class="pull-right"><a class="btn btn-default" href="post.php?fid=<?php echo $cur_section['id'] ?>"><?php _e('Post', 'luna') ?></a></span>
