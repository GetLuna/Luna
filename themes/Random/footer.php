...
?>
		...
		<div class="col-sm-4 col-xs-12"><span class="pull-right" id="poweredby"><?php printf(__('Powered by %s', 'luna'), ' <a href="http://getluna.org/">Luna '.$luna_config['o_cur_version'].'</a>') ?></span></div>
	</div>
</footer>
