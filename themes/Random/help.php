	...
	while ($cur_item = $db->fetch_assoc($result))
		if ($cur_item['visible'] == '1')
			...
			<div class="tab-pane" id="lists">
				<p><a id="lists"></a><?php _e('To create a list you can use the list tag. You can create 2 types of lists using the list tag.', 'luna') ?></p>
			...
			<div class="tab-pane" id="smilies">
				<p><a id="smilies"></a><?php _e('If enabled, the forum can convert a series of smilies to graphical representations. The following smilies you can use are:', 'luna') ?></p>
				<div class="row">
<?php
