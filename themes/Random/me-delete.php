	...
	<fieldset>
		<div class="panel panel-danger">
			<div class="panel-heading">
				<h3 class="panel-title"><?php _e('Please confirm that you want to delete the user', 'luna').' <strong>'.luna_htmlspecialchars($username).'</strong>' ?><span class="pull-right"><input type="submit" class="btn btn-primary" name="delete_user_comply" value="<?php _e('Delete', 'luna') ?>" /></span></h3>
			</div>
