	...
	<div class="row">
		<div class="col-12">
			...
			<nav class="nav nav-tabs">
				<a class="nav-item nav-link active" href="#text" aria-controls="text" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-bold"></i> <?php _e('Text', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#media" aria-controls="media" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-play"></i> <?php _e('Media', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#quote" aria-controls="quote" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-quote-right"></i> <?php _e('Quotes', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#code" aria-controls="code" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-code"></i> <?php _e('Code', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#list" aria-controls="list" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-list"></i> <?php _e('Lists', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#emoji" aria-controls="emoji" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-smile"></i> <?php _e('Emoji', 'luna') ?>
				</a>
			</nav>
...
[/code]</pre>
		...
		while ($cur_item = $db->fetch_assoc($result))
			...
			<h2><i class="fas fa-fw fa-stream"></i> <?php _e('General use', 'luna') ?></h2>
			<p><?php _e('Explains some of the basics on how to work with this forum software.', 'luna') ?></p>
			<nav class="nav nav-tabs">
				<a class="nav-item nav-link active" href="#forum" aria-controls="forum" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-stream"></i> <?php _e('Forums + threads', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#profile" aria-controls="profile" role="tab" data-toggle="tab">
					<i class="fas fa-fw fa-user"></i> <?php _e('Profile', 'luna') ?>
				</a>
				<a class="nav-item nav-link" href="#search" aria-controls="search" role="tab" data-toggle="tab">
			...
			<?php if ($luna_user['is_admmod']) {?>
				...
				<nav class="nav nav-tabs">
					<a class="nav-item nav-link active" href="#forums" aria-controls="forums" role="tab" data-toggle="tab">
						<i class="fas fa-fw fa-th-large"></i> <?php _e('Forums', 'luna') ?>
					</a>
					<a class="nav-item nav-link" href="#threads" aria-controls="threads" role="tab" data-toggle="tab">
						<i class="fas fa-fw fa-stream"></i> <?php _e('Threads', 'luna') ?>
					</a>
					<a class="nav-item nav-link" href="#users" aria-controls="users" role="tab" data-toggle="tab">
						<i class="fas fa-fw fa-users"></i> <?php _e('Users', 'luna') ?>
					</a>
				</nav>
				<div class="tab-content">
