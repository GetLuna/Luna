...
?>
        <div class="row topic-row <?php echo $item_status ?>">
            ...
            <div class="col-md-3 col-sm-4 col-xs-5"> <?php echo '<a href="viewtopic.php?pid='.$cur_search['last_post_id'].'#p'.$cur_search['last_post_id'].'">'.format_time($cur_search['last_post']).'</a> <span class="byuser">'.$lang['by'].' <a href="profile.php?id='.$cur_search['last_poster_id'].'">'.luna_htmlspecialchars($cur_search['last_poster']).'</a>' ?> </span> </div>
        </div>
