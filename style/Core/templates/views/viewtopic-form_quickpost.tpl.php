...
?>
					...
					<div class="panel-footer">
						<div class="btn-group"><input class="btn btn-primary<?php if ($luna_config['o_post_responsive'] == 0) echo ' hidden-sm'; ?>" type="submit" name="submit" tabindex="<?php echo $cur_index++ ?>" value="<?php echo $lang['Submit'] ?>" accesskey="s" /><input class="btn btn-default" type="submit" name="preview" value="<?php echo $lang['Preview'] ?>" tabindex="<?php echo $cur_index++ ?>" accesskey="p" /></div>
						<ul class="bblinks">
