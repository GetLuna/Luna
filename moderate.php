...
if (isset($_GET['get_host']))
{
	...
	message(sprintf($lang_misc['Host info 1'], $ip).'<br />'.sprintf($lang_misc['Host info 2'], @gethostbyaddr($ip)).'<br /><br /><a href="users.php?show_users='.$ip.'">'.$lang_misc['Show more users'].'</a>');
}
