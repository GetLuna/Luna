			...
			<div class="panel-body panel-about">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<b>Core</b> has been updated from version 0.0.36.2563 to 0.2.3652.</p>
					</div>
					<div class="col-sm-6">
						<h4>Bugfixes</h4>
						<p>59 bugs have been fixed.</p>
				...
				<span class="change-list">
					...
					<h4>Preview 2 (version 0.1.3362-0.2.3652)</h4>
					<div class="row">
						<div class="col-sm-6">
							<p>
					...
					<div class="row">
						<div class="col-sm-6">
							<p>
								<span class="label label-danger">3652</span> Backstage will check of config is writeable<br />
								<span class="label label-danger">3652</span> More improvements to Backstage for small screens<br />
								<span class="label label-danger">3652</span> The notification fly-out is now optional<br />
								<span class="label label-danger">3652</span> You can now change the size of emojis<br />
								<span class="label label-danger">3652</span> The copyright notice now can be altered by admins<br />
								<span class="label label-danger">3652</span> Moderation tools are now a Backstage feature<br />
								<span class="label label-danger">3652</span> The profile now shows the user's URL again<br />
								<span class="label label-danger">3652</span> Multiple design improvements to Sunrise<br />
								<span class="label label-danger">3652</span> Help page design has been improved<br />
								<span class="label label-danger">3652</span> Improved design for the "Mark as read" button<br />
								<span class="label label-danger">3652</span> The thread design has been majorly improved<br />
								<span class="label label-danger">3652</span> Index no longer sorts on sticky when no forum is set<br />
								<span class="label label-danger">3652</span> More work on coding conventions has been done<br />
								<span class="label label-danger">3652</span> Improved design for the moderation tools<br />
								<span class="label label-danger">3652</span> Dummy notifications have been removed
							</p>
						</div>
						<div class="col-sm-6">
							<p>
								...
								<span class="label label-danger">3652</span> Core has been removed from the theme engine<br />
								<span class="label label-danger">3652</span> Improvements to the new profile settings<br />
								<span class="label label-danger">3652</span> Notifications have been split from the profile file<br />
								<span class="label label-danger">3652</span> The index no longer shows invalid messages<br />
								<span class="label label-danger">3652</span> Post.php now shows the correct title for the page<br />
								<span class="label label-danger">3652</span> "Moderate" link is added to forum view<br />
								<span class="label label-danger">3652</span> The language files have been cleaned up<br />
								<span class="label label-danger">3652</span> General code cleanup<br />
								<span class="label label-danger">3652</span> New user menu in the Backstage to match the Mainstage's<br />
								<span class="label label-danger">3652</span> Multiple bugfixes
							</p>
						</div>
					</div>
				</span>
