		...
		<div class="panel panel-default">
			...
			<div class="panel-body panel-about">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<h4>Packages</h4>
						<p><b>Core</b> has been updated from version 1.0.4275 to 1.1.4755.<br />
				...
				<h4>Luna 1.1.1 &middot Build 4755</h4>
				<div class="row">
					<div class="col-sm-6">
						<p>
							...
							<span class="label label-primary">Update 1</span> Post counts now decreases when posts are removed
						</p>
					</div>
					<div class="col-sm-6">
						<p>
							...
							<span class="label label-primary">Update 1</span> 1 additional bug fix
						</p>
					</div>
				</div>
			</div>
