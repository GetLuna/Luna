...
<div class="row">
	<div class="col-sm-12">
        ...
        <p class="lead"><?php printf(__('Luna is developed by the %s. Copyright %s. Released under the GPLv2 license.', 'luna'), '<a href="http://getluna.org/">Luna</a>', '2013-2018') ?></p>
        ...
        <section class="release-notes">
            ...
            <h4><i class="fa fa-fw fa-trash-alt"></i> <?php _e('Removed', 'luna') ?></h4>
