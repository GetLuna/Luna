...
<div class="row">
    <div class="col-12">
        <div class="card">
            <h5 class="card-header"><?php _e('Moderate content', 'luna')?></h5>
            <div class="card-body">
...
<div class="row">
    <div class="col-12">
		<form method="post" class="card" action="moderate.php?fid=<?php echo $fid ?>&amp;tid=<?php echo $tid ?>">
            <h5 class="card-header">
                <?php _e('Delete comments', 'luna')?>
                <span class="float-right">
                    <input class="btn btn-link btn-link-danger" type="submit" name="delete_comments_comply" value="<?php _e('Delete', 'luna')?>" />
                </span>
            </h5>
            <div class="card-body">
...
<div class="row">
    <div class="col-12">
		<form id="subject" class="card" class="form-horizontal" method="post" action="moderate.php?fid=<?php echo $fid ?>&amp;tid=<?php echo $tid ?>">
            <h5 class="card-header">
                <?php _e('Split comments', 'luna')?>
                <span class="float-right">
                    <button input type="submit" class="btn btn-link" name="split_comments_comply"><i class="fas fa-fw fa-code-fork"></i> <?php _e('Split', 'luna')?></button>
                </span>
            </h5>
            <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="btn-group btn-breadcrumb btn-group-top">
                        <a class="btn btn-primary" href="../index.php"><span class="fas fa-fw fa-home"></span></a>
...
<?php
    ...
    while ($cur_comment = $db->fetch_assoc($result)) {
        ...
        ?>
                    <div id="p<?php echo $cur_comment['id'] ?>" class="comment<?php if ($cur_comment['id'] == $cur_thread['first_comment_id']) {
            echo ' firstcomment';
        }
        ?><?php echo ($comment_count % 2 == 0) ? ' roweven' : ' rowodd' ?>">
                        <div class="card">
                            <h5 class="card-header">
                                <?php echo $commenter ?> <span class="small"><?php echo $user_title ?></span>
                                <span class="float-right">
                                    #<?php echo ($start_from + $comment_count) ?> &middot; <a href="../thread.php?pid=<?php echo $cur_comment['id'].'#p'.$cur_comment['id'] ?>"><?php echo format_time($cur_comment['commented']) ?></a>
                                </span>
                            </h5>
                            <div class="card-body">
    ...
    <div class="row">
	   <form class="card" method="post" action="moderate.php?fid=<?php echo $fid ?>">
            <h5 class="card-header">
                ...
                <span class="float-right">
                    <button type="submit" class="btn btn-link" name="move_threads_to"><i class="fas fa-fw fa-arrows-alt"></i> <?php _e('Move', 'luna')?></button>
                </span>
            </h5>
			<div class="card-body">
...
<div class="row">
    <div class="col-12">
		<form class="card" method="post" action="moderate.php?fid=<?php echo $fid ?>">
            <h5 class="card-header">
                <?php _e('Merge threads', 'luna')?>
                <span class="float-right">
                    <button type="submit" class="btn btn-link" name="merge_threads_comply"><i class="fas fa-fw fa-compress"></i> <?php _e('Merge', 'luna')?></button>
                </span>
            </h5>
            <div class="card-body">
...
while ($cur_thread = $db->fetch_assoc($result)) {
            ...
            ?>
					<div class="list-group-item <?php echo $item_status ?><?php if ($cur_thread['soft'] == true) {
                echo ' soft';
            }
            ?>">
...
<?php
    ...
    ?>
            ...
            <div class="card-footer">
                ...
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary" name="open"<?php echo $button_status ?>><i class="fas fa-fw fa-check"></i> <?php _e('Open', 'luna')?></button>
                    <button type="submit" class="btn btn-primary" name="close"<?php echo $button_status ?>><i class="fas fa-fw fa-times"></i> <?php _e('Close', 'luna')?></button>
                </div>
            </div>
        </form>
    </div>
