...
if (!empty($plugins)) {
    ?>
                            <li class="dropdown<?php if (SECTION == ' extensions') {
        echo 'active';
    }
    ?>">
            ...
            <div class="jumbotron jumboheader primary">
                <div class="container">
                    <ul class="nav nav-tabs nav-main" role="tablist">
                        ...
                        <li role="presentation" class="<?php if (LUNA_SECTION == 'backstage') {
    echo 'active';
}
?>"><a href="#index" aria-controls="index" role="tab" data-toggle="tab"><i class="fa fa-fw fa-dashboard"></i><span class="hidden-xs"> <?php _e('Backstage', 'luna')?></span></a></li>
                        <li role="presentation" class="<?php if (LUNA_SECTION == 'content') {
    echo 'active';
}
?>"><a href="#content" aria-controls="content" role="tab" data-toggle="tab"><i class="fa fa-fw fa-file"></i><span class="hidden-xs"> <?php _e('Content', 'luna')?></span></a></li>
                        <li role="presentation" class="<?php if (LUNA_SECTION == 'users') {
    echo 'active';
}
?>"><a href="#users" aria-controls="users" role="tab" data-toggle="tab"><i class="fa fa-fw fa-users"></i><span class="hidden-xs"> <?php _e('Users', 'luna')?></span></a></li>
                        <?php if ($is_admin) {?>
                        <li role="presentation" class="<?php if (LUNA_SECTION == 'settings') {
    echo 'active';
}
    ?>"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"><i class="fa fa-fw fa-cogs"></i><span class="hidden-xs"> <?php _e('Settings', 'luna')?></span></a></li>
                        <li role="presentation" class="<?php if (LUNA_SECTION == 'maintenance') {
        echo 'active';
    }
    ?>"><a href="#maintenance" aria-controls="maintenance" role="tab" data-toggle="tab"><i class="fa fa-fw fa-coffee"></i><span class="hidden-xs"> <?php _e('Maintenance', 'luna')?></span></a></li>
                        <?php }?>
                    </ul>
                </div>
            </div>
            <div class="jumbotron jumboheader secondary">
                <div class="container">
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane <?php if (LUNA_SECTION == 'backstage') {
    echo 'active';
}
?>" id="index">
                            <ul class="nav nav-tabs nav-main" role="tablist">
                                <li<?php if (LUNA_PAGE == 'index') {
    echo ' class="active"';
}
?>><a href="index.php"><i class="fa fa-fw fa-tachometer"></i> <?php _e('Backstage', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'update') {
    echo ' class="active"';
}
?>><a href="update.php"><i class="fa fa-fw fa-cloud-upload"></i> <?php _e('Update', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'about') {
    echo ' class="active"';
}
?>><a href="about.php"><i class="fa fa-fw fa-moon-o"></i> <?php _e('About', 'luna')?></a></li>
                            </ul>
                        </div>
                        <div role="tabpanel" class="tab-pane <?php if (LUNA_SECTION == 'content') {
    echo 'active';
}
?>" id="content">
                            <ul class="nav nav-tabs nav-main" role="tablist">
                                <li<?php if (LUNA_PAGE == 'board') {
    echo ' class="active"';
}
?>><a href="board.php"><i class="fa fa-fw fa-list"></i> <?php _e('Board', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'reports') {
    echo ' class="active"';
}
?>><a href="reports.php"><i class="fa fa-fw fa-flag"></i> <?php _e('Reports', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'censoring') {
    echo ' class="active"';
}
?>><a href="censoring.php"><i class="fa fa-fw fa-eye-slash"></i> <?php _e('Censoring', 'luna')?></a></li>
                            </ul>
                        </div>
                        <div role="tabpanel" class="tab-pane <?php if (LUNA_SECTION == 'users') {
    echo 'active';
}
?>" id="users">
                            <ul class="nav nav-tabs nav-main" role="tablist">
                                <li<?php if (LUNA_PAGE == 'users') {
    echo ' class="active"';
}
?>><a href="users.php"><i class="fa fa-fw fa-search"></i> <?php _e('Search', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'ranks') {
    echo ' class="active"';
}
?>><a href="ranks.php"><i class="fa fa-fw fa-trophy"></i> <?php _e('Ranks', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'groups') {
    echo ' class="active"';
}
?>><a href="groups.php"><i class="fa fa-fw fa-group"></i> <?php _e('Groups', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'bans') {
    echo ' class="active"';
}
?>><a href="bans.php"><i class="fa fa-fw fa-ban"></i> <?php _e('Bans', 'luna')?></a></li>
                            </ul>
                        </div>
                        <?php if ($is_admin) {?>
                        <div role="tabpanel" class="tab-pane <?php if (LUNA_SECTION == 'settings') {
    echo 'active';
}
    ?>" id="settings">
                            <ul class="nav nav-tabs nav-main" role="tablist">
                                <li<?php if (LUNA_PAGE == 'settings') {
        echo ' class="active"';
    }
    ?>><a href="settings.php"><i class="fa fa-fw fa-cogs"></i> <?php _e('Settings', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'features') {
        echo ' class="active"';
    }
    ?>><a href="features.php"><i class="fa fa-fw fa-sliders"></i> <?php _e('Features', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'appearance') {
        echo ' class="active"';
    }
    ?>><a href="appearance.php"><i class="fa fa-fw fa-paint-brush"></i> <?php _e('Theme', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'menu') {
        echo ' class="active"';
    }
    ?>><a href="menu.php"><i class="fa fa-fw fa-bars"></i> <?php _e('Menu', 'luna')?></a></li>
                            </ul>
                        </div>
                        <div role="tabpanel" class="tab-pane <?php if (LUNA_SECTION == 'maintenance') {
        echo 'active';
    }
    ?>" id="maintenance">
                            <ul class="nav nav-tabs nav-main" role="tablist">
                                <li<?php if (LUNA_PAGE == 'maintenance') {
        echo ' class="active"';
    }
    ?>><a href="maintenance.php"><i class="fa fa-fw fa-coffee"></i> <?php _e('Maintenance', 'luna')?></a></li>
                                <li<?php if (LUNA_PAGE == 'prune') {
        echo ' class="active"';
    }
    ?>><a href="prune.php"><i class="fa fa-fw fa-recycle"></i> <?php _e('Prune', 'luna')?></a></li>
                            </ul>
                        </div>
                        <?php }?>
                    </div>
