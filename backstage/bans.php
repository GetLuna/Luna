...
<div class="row">
	<div class="col-md-12">
        <form class="card" id="bans2" method="post" action="bans.php">
            <h5 class="card-header">
                <?php _e('Ban range', 'luna')?>
                <span class="float-right">
                    <button class="btn btn-link btn-link-danger" type="submit" name="add_edit_ban" tabindex="6"><span class="fas fa-fw fa-ban"></span> <?php _e('Ban', 'luna')?></button>
                </span>
            </h5>
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('Username', 'luna')?><span class="help-block"><?php _e('The username to ban', 'luna')?></span></label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('IP address/IP-ranges', 'luna')?><span class="help-block"><?php _e('The IP you wish to ban, separate addresses with spaces', 'luna')?></span></label>
                    <div class="col-md-9">
...
if ($ban_user != '' && isset($user_id)) {
    printf('<span class="help-block">'.__('Click %s to see IP statistics for this user.', 'luna').'</span>', '<a href="users.php?ip_stats='.$user_id.'">'.__('here', 'luna').'</a>');
}
?>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('Email', 'luna')?><span class="help-block"><?php _e('The email or email domain you wish to ban', 'luna')?></span></label>
                    <div class="col-md-9">
...
<div class="row">
	<div class="col-12">
        <form class="card" id="bans" method="post" action="bans.php?action=more">
            <h5 class="card-header">
                <?php _e('Add ban', 'luna')?>
                <span class="float-right">
                    <button class="btn btn-link btn-link-danger" type="submit" name="add_ban" tabindex="2"><span class="fas fa-fw fa-plus"></span> <?php _e('Add', 'luna')?></button>
                </span>
            </h5>
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('Username', 'luna')?><span class="help-block"><?php _e('If you want to ban a specific IP/IP-range or email, leave it blank', 'luna')?></span></label>
                    <div class="col-md-9">
        ...
        <form class="card" id="find_bans" method="get" action="bans.php">
            <h5 class="card-header">
                <?php _e('Ban search', 'luna')?>
                <span class="float-right">
                    <button class="btn btn-link" type="submit" name="find_ban"><span class="fas fa-fw fa-search"></span> <?php _e('Search', 'luna')?></button>
                </span>
            </h5>
            <div class="alert alert-info"><i class="fas fa-fw fa-info-circle"></i> <?php _e('Enter user data to filter by. Use the wildcard character * for partial matches.', 'luna')?></div>
            <div class="card-body">
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('IP address/IP-ranges', 'luna')?></label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('Expire after', 'luna')?></label>
                    <div class="col-md-9">
                        <input type="date" class="form-control" name="expire_after" maxlength="10" tabindex="8" placeholder="<?php _e('(yyyy-mm-dd)', 'luna')?>" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php _e('Expire before', 'luna')?></label>
                    <div class="col-md-9">
