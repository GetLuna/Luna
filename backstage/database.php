...
if (isset($_POST['backupstart'])) {
	// Output sql dump
	$tables = array('bans', 'categories', 'censoring', 'config', 'forums', 'forum_perms', 'forum_subscriptions', 'groups', 'menu', 'messages', 'notifications', 'online', 'posts', 'ranks', 'reports', 'search_cache', 'search_matches', 'search_words', 'threads', 'thread_subscriptions', 'users');
