...
<?php if ($luna_config['o_first_run_backstage'] == 0) {?>
        <div class="card text-white bg-primary">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <a href="about.php" class="btn btn-light col"><?php _e('What\'s new', 'luna')?></a>
                    <a href="board.php" class="btn btn-light col"><?php _e('Create new sections', 'luna')?></a>
                    <a href="features.php" class="btn btn-light col"><?php _e('Alter functionality', 'luna')?></a>
...
<?php }?>
        <div class="card">
            <h5 class="card-header">
                <?php _e('New reports', 'luna')?>
                <span class="float-right">
                    <a class="btn btn-link" href="reports.php"><span class="fas fa-fw fa-eye"></span> <?php _e('View all', 'luna')?></a>
                </span>
            </h5>
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th><?php _e('Reported by', 'luna')?></th>
                            <th><?php _e('Date and time', 'luna')?></th>
...
if (substr(sprintf('%o', fileperms(LUNA_ROOT.'config.php')), -4) > '644'): ?>
        <div class="alert alert-warning">
            <i class="fas fa-fw fa-exclamation-triangle"></i> <?php _e('The config file is writeable at this moment, you might want to set the CHMOD to 640 or 644.', 'luna')?>
        </div>
<?php endif;

if ($install_file_exists): ?>
        <div class="alert alert-warning">
            <i class="fas fa-fw fa-exclamation-triangle"></i> <?php _e('The file install.php still exists, but should be removed.', 'luna')?>
        </div>
<?php endif;?>
        <div class="card text-white bg-primary">
            <h5 class="card-header">
