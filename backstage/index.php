...
?>
				<h3><?php _e('You\'re using a preview of Luna!', 'luna') ?></h3>
				<p><?php _e('We release every now and then a new build for Luna, one more stable then the other, for you to check out. You can keep track of this at <a href="https://github.com/GetLuna/Luna/releases">our GitHub repository</a>. New builds can contain new features, improved features, and/or bugfixes.', 'luna') ?></p>
<?php
}
?>
			</div>
