        ...
        <div class="card">
            <div class="card-header card-nav">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="#new" aria-controls="old" role="tab" data-toggle="tab"><i class="fas fa-fw fa-flag"></i> <?php _e('New reports', 'luna')?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#old" aria-controls="old" role="tab" data-toggle="tab"><i class="far fa-fw fa-flag"></i> <?php _e('Old reports', 'luna')?></a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
        ...
        ?>
                            <div class="card">
                                <h5 class="card-header">
                                    <?php echo $reporter ?>
                                    <span class="dimmed"> &middot; <?php echo format_time($cur_report['created']) ?></span>
                                </h5>
                                <div class="card-body">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <?php echo implode('', $report_location) ?>
                                        </ol>
                                    </nav>
                                    <?php echo $message ?>
                                    <hr />
    ...
    while ($cur_report = $db->fetch_assoc($result)) {
        ...
        ?>
                            <div class="card">
                                <h5 class="card-header">
                                    <?php echo $reporter ?>
                                    <span class="dimmed"> &middot; <?php echo format_time($cur_report['zapped']) ?></span>
                                </h5>
                                <div class="card-body">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
