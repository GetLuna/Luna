...
if (isset($_POST['form_sent']))
{
	...
	$form = array(
		...
		'default_dst'			=> isset($_POST['form']['default_dst']) ? '0' : '1',
		...
		'avatars'				=> isset($_POST['form']['avatars']) ? '0' : '1',
		...
		'regs_allow'			=> isset($_POST['form']['regs_allow']) ? '0' : '1',
		'regs_verify'			=> isset($_POST['form']['regs_verify']) ? '0' : '1',
		'regs_report'			=> isset($_POST['form']['regs_report']) ? '0' : '1',
		'rules'					=> isset($_POST['form']['rules']) ? '0' : '1',
		...
		'announcement'			=> isset($_POST['form']['announcement']) ? '0' : '1',
		'announcement_message'	=> pun_trim($_POST['form']['announcement_message']),
		'maintenance'			=> isset($_POST['form']['maintenance']) ? '0' : '1',
