...
<div class="row">
    <div class="col-12">
        <form class="card" id="groups2" method="post" action="groups.php" onsubmit="return process_form(this)">
            <h5 class="card-header">
                <?php echo __('Group settings', 'luna') ?>
                <span class="float-right">
                    <button class="btn btn-link" type="submit" name="add_edit_group"><span class="fas fa-fw fa-check"></span> <?php echo __('Save', 'luna') ?></button>
                </span>
            </h5>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Group title', 'luna') ?></label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('User title', 'luna') ?><span class="help-block"><?php echo __('The title will override the user rank', 'luna') ?></span></label>
                    <div class="col-md-9">
                ...
                <?php if ($group['g_id'] != LUNA_ADMIN): if ($group['g_id'] != LUNA_GUEST): if ($mode != 'edit' || $luna_config['o_default_user_group'] != $group['g_id']): ?>
                        <hr />
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label"> <?php echo __('Moderator privileges', 'luna') ?></label>
                            <div class="col-md-9">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="moderator" name="moderator" value="1"<?php echo ( $group['g_moderator'] == '1' ) ? ' checked' : '' ?> tabindex="5">
                                    <label class="custom-control-label" for="moderator">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="mod_edit_users" name="mod_edit_users" value="1"<?php echo ( $group['g_mod_edit_users'] == '1' ) ? ' checked' : '' ?> tabindex="6">
                                    <label class="custom-control-label" for="mod_edit_users">
                                        <?php echo __('Allow moderators to edit user profiles.', 'luna') ?>
                                    </label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="mod_rename_users" name="mod_rename_users" value="1"<?php echo ( $group['g_mod_rename_users'] == '1' ) ? ' checked' : '' ?> tabindex="7">
                                    <label class="custom-control-label" for="mod_rename_users">
                                        <?php echo __('Allow moderators to rename users.', 'luna') ?>
                                    </label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="mod_change_passwords" name="mod_change_passwords" value="1"<?php echo ( $group['g_mod_change_passwords'] == '1' ) ? ' checked' : '' ?> tabindex="8">
                                    <label class="custom-control-label" for="mod_change_passwords">
                                        <?php echo __('Allow moderators to change user passwords.', 'luna') ?>
                                    </label>
                                </div>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="mod_ban_users" name="mod_ban_users" value="1"<?php echo ( $group['g_mod_ban_users'] == '1' ) ? ' checked' : '' ?> tabindex="9">
                                    <label class="custom-control-label" for="mod_ban_users">
    ...
    <?php if ( $group['g_id'] != LUNA_ADMIN): if ( $group['g_id'] != LUNA_GUEST): ?>
                    <hr />
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label"><?php echo __('Inbox', 'luna') ?></label>
                        <div class="col-md-9">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="allow_inbow" name="allow_inbow" value="1"<?php echo ( $group['g_inbox'] == '1' ) ? ' checked' : '' ?> tabindex="10">
                                <label class="custom-control-label" for="allow_inbow">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label"><?php echo __('Receivers', 'luna') ?><p class="help-block"><?php echo __('The maximum amount of messages a user in this group can have in his Inbox. 0 is no limit', 'luna') ?></p></label>
                        <div class="col-md-9">
        ...
        <?php endif;endif;?>
                <hr />
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Read', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="read_board" name="read_board" value="1"<?php echo ( $group['g_read_board'] == '1' ) ? ' checked' : '' ?> tabindex="11">
                            <label class="custom-control-label" for="read_board">
                                <?php echo __('If this is disabled, users will only be able to login and logout.', 'luna') ?>
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="view_users" name="view_users" value="1"<?php echo ( $group['g_view_users'] == '1' ) ? ' checked' : '' ?> tabindex="12">
                            <label class="custom-control-label" for="view_users">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Create', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="comment" name="comment" value="1"<?php echo ( $group['g_comment'] == '1' ) ? ' checked' : '' ?> tabindex="13">
                            <label class="custom-control-label" for="comment">
                                <?php echo __('Allow users to comment in threads.', 'luna') ?>
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="create_threads" name="create_threads" value="1"<?php echo ( $group['g_create_threads'] == '1' ) ? ' checked' : '' ?> tabindex="14">
                            <label class="custom-control-label" for="create_threads">
    ...
    <?php if ($group['g_id'] != LUNA_GUEST): ?>
                <hr />
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Edit', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="edit_comments" name="edit_comments" value="1"<?php echo ( $group['g_edit_comments'] == '1' ) ? ' checked' : '' ?> tabindex="15">
                            <label class="custom-control-label" for="edit_comments">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Delete', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="delete_comments" name="delete_comments" value="1"<?php echo ( $group['g_delete_comments'] == '1' ) ? ' checked' : '' ?> tabindex="16">
                            <label class="custom-control-label" for="delete_comments">
                                <?php echo __('Allow users to delete their own comments.', 'luna') ?>
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="delete_threads" name="delete_threads" value="1"<?php echo ( $group['g_delete_threads'] == '1' ) ? ' checked' : '' ?> tabindex="17">
                            <label class="custom-control-label" for="delete_threads">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Hide', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="soft_delete_view" name="soft_delete_view" value="1"<?php echo ( $group['g_soft_delete_view'] == '1' ) ? ' checked' : '' ?> tabindex="18">
                            <label class="custom-control-label" for="soft_delete_view">
                                <?php echo __('Allow users to view threads and comments that have been hidden.', 'luna') ?>
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="soft_delete_comments" name="soft_delete_comments" value="1"<?php echo ( $group['g_soft_delete_comments'] == '1' ) ? ' checked' : '' ?> tabindex="19">
                            <label class="custom-control-label" for="soft_delete_comments">
                                <?php echo __('Allow users to hide comments from all users.', 'luna') ?>
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="soft_delete_threads" name="soft_delete_threads" value="1"<?php echo ( $group['g_soft_delete_threads'] == '1' ) ? ' checked' : '' ?> tabindex="20">
                            <label class="custom-control-label" for="soft_delete_threads">
    ...
    <?php if ($group['g_id'] != LUNA_GUEST): ?>
                <hr />
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('User title', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="set_title" name="set_title" value="1"<?php echo ( $group['g_set_title'] == '1' ) ? ' checked' : '' ?> tabindex="21">
                            <label class="custom-control-label" for="set_title">
    ...
    <?php endif;?>
                <hr />
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Search', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="search" name="search" value="1"<?php echo ( $group['g_search'] == '1' ) ? ' checked' : '' ?> tabindex="22">
                            <label class="custom-control-label" for="search">
                                <?php echo __('Allow users to use the search feature for threads and comments.', 'luna') ?>
                            </label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="search_users" name="search_users" value="1"<?php echo ( $group['g_search_users'] == '1' ) ? ' checked' : '' ?> tabindex="23">
                            <label class="custom-control-label" for="search_users">
    ...
    <?php if ($group['g_id'] != LUNA_GUEST): ?>
                <hr />
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Send emails', 'luna') ?></label>
                    <div class="col-md-9">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="send_email" name="send_email" value="1"<?php echo ( $group['g_send_email'] == '1' ) ? ' checked' : '' ?> tabindex="24">
    ...
    <?php endif;?>
                <hr />
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Comment flood interval', 'luna') ?><span class="help-block"><?php echo __('Time users have to wait between comments', 'luna') ?></span></label>
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text"><?php echo __('seconds', 'luna') ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Search flood interval', 'luna') ?><span class="help-block"><?php echo __('Time users have to wait between searches', 'luna') ?></span></label>
                    <div class="col-md-9">
                        <div class="input-group">
    ...
    <?php if ($group['g_id'] != LUNA_GUEST): ?>
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Email flood interval', 'luna') ?><span class="help-block"><?php echo __('Time users have to wait between emails', 'luna') ?></span></label>
                    <div class="col-md-9">
                        <div class="input-group">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label"><?php echo __('Report flood interval', 'luna') ?><span class="help-block"><?php echo __('Time users have to wait between reports', 'luna') ?></span></label>
                    <div class="col-md-9">
                        <div class="input-group">
...
elseif (isset($_GET['del_group'])) {
    ...
    if (!$db->num_rows($result) || isset($_POST['del_group'])) {
        if (isset($_POST['del_group_comply']) || isset($_POST['del_group'])) {
            ...
            ?>
<form method="post" class="card" action="groups.php?del_group=<?php echo $group_id ?>">
	<h5 class="card-header">
...
<?php
        ...
        require 'header.php';
?>
<form id="groups" class="card" method="post" action="groups.php?del_group=<?php echo $group_id ?>">
    <h5 class="card-header">
        <?php printf(__('Delete group %s', 'luna'), '<b>'.luna_htmlspecialchars($group_title).'</b>')?>
        <span class="float-right">
	...
	<div class="card-body">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label"><?php echo __('Move users to', 'luna') ?></label>
            <div class="col-md-9">
...
<div class="row">
	<div class="col-md-4">
        <form id="groups" class="card" method="post" action="groups.php">
            <h5 class="card-header">
                <?php echo __('New group base', 'luna') ?>
                <span class="float-right">
                    <button class="btn btn-link" type="submit" name="add_group" tabindex="2"><span class="fas fa-fw fa-plus"></span> <?php echo __('Add', 'luna') ?></button>
                </span>
            </h5>
            <div class="card-body">
...
?>
        ...
        <form id="groups" class="card" method="post" action="groups.php">
			<h5 class="card-header">
                <?php echo __('Default group', 'luna') ?>
                <span class="float-right">
                    <button class="btn btn-link" type="submit" name="set_default_group"><span class="fas fa-fw fa-check"></span> <?php echo __('Save', 'luna') ?></button>
                </span>
			</h5>
			<div class="card-body">
...
<?php
	...
	<div class="col-md-8">
		<div class="card">
			<h5 class="card-header">
                <?php echo __('Manage groups', 'luna') ?>
			</h5>
