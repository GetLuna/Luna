            ...
            <?php if ($group['g_id'] != LUNA_ADMIN): if ($group['g_id'] != LUNA_GUEST): if ($mode != 'edit' || $luna_config['o_default_user_group'] != $group['g_id']): ?>
		                        ...
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-9">
		                                <div class="checkbox">
		                                    <label>
		                                        <input type="checkbox" name="moderator" value="1"<?php if ($group['g_moderator'] == '1') {
                echo ' checked';
            }
            ?> tabindex="5" />
		                                ...
		                                <div class="checkbox">
		                                    <label>
		                                        <input type="checkbox" name="mod_edit_users" value="1"<?php if ($group['g_mod_edit_users'] == '1') {
                echo ' checked';
            }
            ?> tabindex="7" />
		                                ...
		                                <div class="checkbox">
		                                    <label>
		                                        <input type="checkbox" name="mod_rename_users" value="1"<?php if ($group['g_mod_rename_users'] == '1') {
                echo ' checked';
            }
            ?> tabindex="9" />
		                                ...
		                                <div class="checkbox">
		                                    <label>
		                                        <input type="checkbox" name="mod_change_passwords" value="1"<?php if ($group['g_mod_change_passwords'] == '1') {
                echo ' checked';
            }
            ?> tabindex="11" />
		                                ...
		                                <div class="checkbox">
		                                    <label>
		                                        <input type="checkbox" name="mod_ban_users" value="1"<?php if ($group['g_mod_ban_users'] == '1') {
                echo ' checked';
            }
            ?> tabindex="13" />
            ...
            <?php if ($group['g_id'] != LUNA_ADMIN): if ($group['g_id'] != LUNA_GUEST): ?>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-9">
	                                <div class="checkbox">
	                                    <label>
	                                        <input type="checkbox" name="inbox_allow" value="1" <?php if ($group['g_inbox'] == '1') {
            echo ' checked';
        }
        ?> />
	            ...
	            <?php endif;endif;?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="read_board" value="1"<?php if ($group['g_read_board'] == '1') {
        echo ' checked';
    }
    ?> tabindex="15" />
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="view_users" value="1"<?php if ($group['g_view_users'] == '1') {
        echo ' checked';
    }
    ?> tabindex="17" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="comment" value="1"<?php if ($group['g_comment'] == '1') {
        echo ' checked';
    }
    ?> tabindex="19" />
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="create_threads" value="1"<?php if ($group['g_create_threads'] == '1') {
        echo ' checked';
    }
    ?> tabindex="21" />
            ...
            <?php if ($group['g_id'] != LUNA_GUEST): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="edit_comments" value="1"<?php if ($group['g_edit_comments'] == '1') {
        echo ' checked';
    }
    ?> tabindex="23" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="delete_comments" value="1"<?php if ($group['g_delete_comments'] == '1') {
        echo ' checked';
    }
    ?> tabindex="25" />
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="delete_threads" value="1"<?php if ($group['g_delete_threads'] == '1') {
        echo ' checked';
    }
    ?> tabindex="27" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="soft_delete_view" value="1" <?php if ($group['g_soft_delete_view'] == '1') {
        echo ' checked';
    }
    ?> />
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="soft_delete_comments" value="1" <?php if ($group['g_soft_delete_comments'] == '1') {
        echo ' checked';
    }
    ?> />
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="soft_delete_threads" value="1" <?php if ($group['g_soft_delete_threads'] == '1') {
        echo ' checked';
    }
    ?> />
            ...
            <?php if ($group['g_id'] != LUNA_GUEST): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="set_title" value="1"<?php if ($group['g_set_title'] == '1') {
        echo ' checked';
    }
    ?> tabindex="31" />
            ...
            <?php endif;?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="search" value="1"<?php if ($group['g_search'] == '1') {
        echo ' checked';
    }
    ?> tabindex="33" />
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="search_users" value="1"<?php if ($group['g_search_users'] == '1') {
        echo ' checked';
    }
    ?> tabindex="35" />
            ...
            <?php if ($group['g_id'] != LUNA_GUEST): ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="send_email" value="1"<?php if ($group['g_send_email'] == '1') {
        echo ' checked';
    }
    ?> tabindex="37" />
