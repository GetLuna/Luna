	...
	<?php endif; endif; ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="post_topics" value="1"<?php if ($group['g_create_threads'] == '1') echo ' checked' ?> tabindex="21" />
